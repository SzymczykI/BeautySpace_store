...
const Profile = () => {
    ...
    const changeAvatar = (e) => {
        ...
        if (file.size > 1024 * 1024) return dispatch({ type: 'NOTIFY', payload: { error: 'The largest image size is 1mb' } });
        ...
        <div className='profile_page'>
            ...
            <section className="row text-secondary my-3">
                <div className='col-md-4'>
                    ...
                    <button className="btn btn-primary" style={{ backgroundColor: '#E2BB66', border: '#E2BB66' }}
                        disabled={notify.loading} onClick={handleUpdateProfile} >
                        Update
                    </button>
                </div>
